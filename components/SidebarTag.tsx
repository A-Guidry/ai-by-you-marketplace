...
export const SidebarTag = ({ label, count }: SidebarTagProps) => (
    <Link href={`/?feature=${encodeURIComponent(label)}`} className="flex items-center justify-between w-full p-2 rounded hover:bg-slate-800 transition-colors cursor-pointer group">
